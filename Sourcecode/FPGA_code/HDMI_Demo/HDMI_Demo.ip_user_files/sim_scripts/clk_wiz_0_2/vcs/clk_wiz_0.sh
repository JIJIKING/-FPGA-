...
#
# Generated by Vivado on Tue Jul 28 12:13:52 +0800 2020
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../HDMI_Demo.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../HDMI_Demo.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
